...
export default CultureSeaweeds;*/}
    ...
    return(
        <>
            ...
            <Box className={classes.WhoWeAreContainer}>
                ...
                <SubSection id='Sub Section-1' accordianId='5' Section='CultureSeaweeds'/>
                {subpages.map((sub) => (
                    <SubSection key={sub.id} id={sub.id} accordianId='5' Section='CultureSeaweeds' onDelete={() => handleDeleteSubpage(sub.id)} />
                ))}
                {banner.map((sub)=>(
                    <Banner key={sub.id} id={sub.id} accordianId='5' Section='CultureSeaweeds' onDelete={() => handleDeleteBanner(sub.id)}/>
                ))}
            </Box>
        </>
    )
