    ...
    return(
        <>
            ...
            <Box className={classes.WhoWeAreContainer}>
                ...
                <SubSection id='Sub Section-1' accordianId='6' Section='CultureMurrel'/>
                {subpages.map((sub) => (
                    <SubSection key={sub.id} id={sub.id} accordianId='6' Section='CultureMurrel' onDelete={() => handleDeleteSubpage(sub.id)} />
                ))}
                {banner.map((sub)=>(
                    <Banner key={sub.id} id={sub.id} accordianId='6' Section='CultureMurrel' onDelete={() => handleDeleteBanner(sub.id)}/>
                ))}
            </Box>
        </>
    )
