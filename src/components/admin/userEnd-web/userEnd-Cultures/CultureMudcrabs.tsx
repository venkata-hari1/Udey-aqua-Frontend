...
export default CultureMudcrabs;*/}
    ...
    return(
        <>
            ...
            <Box className={classes.WhoWeAreContainer}>
                ...
                <SubSection id='Sub Section-1' accordianId='8' Section='CultureMudcrabs'/>
                {subpages.map((sub) => (
                    <SubSection key={sub.id} id={sub.id} accordianId='8' Section='CultureMudcrabs' onDelete={() => handleDeleteSubpage(sub.id)} />
                ))}
                {banner.map((sub)=>(
                    <Banner key={sub.id} id={sub.id} accordianId='8' Section='CultureMudcrabs' onDelete={() => handleDeleteBanner(sub.id)}/>
                ))}
            </Box>
        </>
    )
